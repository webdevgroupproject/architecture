    ...
    <div class="form-container">
        <form method="get" action="addEventAction.php" id="addEventForm">
            <fieldset>
                ...
                <input style="width: 150px;" type="text" name="postcode" class="form-control block" placeholder="Please enter a valid UK postcode"
            ...
            <fieldset>
                ...
                <input style="width: 150px;" type="number" name="spaces" class="form-control block" data-validation="required"><br>
